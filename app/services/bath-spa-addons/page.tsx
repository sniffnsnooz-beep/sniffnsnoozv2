...
import { bathSpaAddons } from "@/data/bathSpaAddons";
import { useBooking } from "@/context/BookingContext";
import { useRouter } from "next/navigation";

export default function BathSpaAddonsPage() {
  ...
  function handleAdd(service: any) {
    addItem({
      ...
      price: service.price,
      time: service.time,
      category: "Hydra bath & Spa Add-ons",
    });
  }
    ...
    <section className="bg-[#f6efe6] py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h1 className="text-4xl font-serif text-[#5b3a26] mb-12">
          Hydra bath & Spa Add-ons
        </h1>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {bathSpaAddons.map((s, i) => (
            <div
              key={i}
              className="bg-white rounded-xl px-5 py-4 flex justify-between items-center shadow-sm"
            >
              <div>
