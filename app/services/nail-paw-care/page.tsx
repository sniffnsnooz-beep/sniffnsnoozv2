...
import { nailPawCareServices } from "@/data/nailPawCareServices";
import { useBooking } from "@/context/BookingContext";
import { useRouter } from "next/navigation";

export default function NailPawCarePage() {
  ...
  function handleAdd(service: any) {
    addItem({
      ...
      price: service.price,
      time: service.time,
      category: "Nail & Paw Care Services",
    });
  }
    ...
    <section className="bg-[#f6efe6] py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h1 className="text-4xl font-serif text-[#5b3a26] mb-12">
          Nail & Paw Care Services
        </h1>

        {/* GRID — SAME AS HAIR & EAR */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {nailPawCareServices.map((s, i) => (
            <div
              key={i}
              className="
                bg-white
