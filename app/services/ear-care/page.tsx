...
import { earCareServices } from "@/data/earCareServices";
  ...
  return (
    <section className="bg-[#f6efe6] py-28">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* GRID LAYOUT – SAME AS HAIR STYLING */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {earCareServices.map((s, i) => (
            <div
              key={i}
              className="
                bg-white
        ...
        {/* ✅ PROCEED TO BOOKING (ONLY WHEN CART HAS ITEMS) */}
        {items.length > 0 && (
