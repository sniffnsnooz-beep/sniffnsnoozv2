    ...
    <html lang="en">
      <head>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-WRS3SCPB');
            `,
          }}
        />
        ...
        <Script
          id="ga-script"
          strategy="afterInteractive"
          src="https://www.googletagmanager.com/gtag/js?id=G-C819C0F186"
        />
        <Script
          id="ga-init"
          strategy="afterInteractive"
      ...
      <body className="antialiased min-h-screen flex flex-col bg-stone-50 font-sans selection:bg-amber-200">
        {/* ========================= 
            📊 GOOGLE TAG MANAGER (noscript)
        ========================= */}
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-WRS3SCPB"
            height="0" 
            width="0" 
